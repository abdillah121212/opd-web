                    ...
                    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                        ...
                        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
                            ...
                            <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true"
                                ...
                                data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-s croll-offset="5px"
                                        ...
                                        <div class="timeline timeline-border-dashed">
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <div class="timeline-content mb-10 mt-n1">
                                                    ...
                                                    <div class="pe-3 mb-5">
                                                        <!--begin::Title-->
                                                        <div class="fs-5 fw-semibold mb-2">There are 2 new tasks for
                                                            you in “AirPlus Mobile
                                                            App” project:</div>
                                                        <!--end::Title-->
                                                        <!--begin::Description-->
                                                ...
                                                <div class="timeline-content mb-10 mt-n1">
                                                    ...
                                                    <div class="overflow-auto pb-5">
                                                        <div
                                                            ...
                                                            <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                                <!--begin::Icon-->
                                                                <img alt="apps/projects/project.html"
                                                                    class="w-30px me-3"
                                                ...
                                                <div class="timeline-content mb-10 mt-n1">
                                                    ...
                                                    <div class="pe-3 mb-5">
                                                        ...
                                                        <div class="fs-5 fw-semibold mb-2">New case
                                                            <a href="#"
                                                                class="text-primary fw-bold me-1">#67890</a>is
                                                            assigned to
                                                        ...
                                                        <div class="overflow-auto pb-5">
                                                            ...
                                                            <div class="d-flex align-items-center mt-1 fs-6">
                                                                ...
                                                                <!--begin::User-->
                                                                <a href="#"
                                                                    class="text-primary fw-bold me-1">Alice Tan</a>
                                                                <!--end::User-->
                                                            </div>
                                                            <!--end::Wrapper-->
                                                        </div>
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <div class="timeline-content mb-10 mt-n1">
                                                    ...
                                                    <div class="pe-3 mb-5">
                                                        ...
                                                        <div class="d-flex align-items-center mt-1 fs-6">
                                                            <!--begin::Info-->
                                                            <div class="text-muted me-2 fs-7">Placed at 5:05 AM by
                                                            </div>
                                                            <!--end::Info-->
                                                            <!--begin::User-->
                                                            <div class="symbol symbol-circle symbol-25px"
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <div class="timeline-content mt-n1">
                                                    ...
                                                    <div class="pe-3 mb-5">
                                                        ...
                                                        <div class="d-flex align-items-center mt-1 fs-6">
                                                            <!--begin::Info-->
                                                            <div class="text-muted me-2 fs-7">Placed at 4:23 PM by
                                                            </div>
                                                            <!--end::Info-->
                                                            <!--begin::User-->
                        ...
                        <div id="kt_shopping_cart" class="bg-body" data-kt-drawer="true"
                            data-kt-drawer-name="cart" data-kt-drawer-activate="true"
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex flex-column me-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <span class="text-gray-500 fw-semibold d-block">Professional camera
                                                    for edge</span>
                                            </div>
                                            <!--end::Section-->
                                            <!--begin::Section-->
                                        ...
                                        <div class="d-flex flex-column me-3">
                                            ...
                                            <div class="mb-3">
                                                <a href="apps/ecommerce/sales/details.html"
                                                    ...
                                                    Printer</a>
                                                <span class="text-gray-500 fw-semibold d-block">Manfactoring unique
                                                    objekts</span>
                                            </div>
                                            <!--end::Section-->
                                            <!--begin::Section-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex flex-column me-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <span class="text-gray-500 fw-semibold d-block">Perfect animation
                                                    tool</span>
                                            </div>
                                            <!--end::Section-->
                                            <!--begin::Section-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex flex-column me-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <span class="text-gray-500 fw-semibold d-block">Profile info,Timeline
                                                    etc</span>
                                            </div>
                                            <!--end::Section-->
                                            <!--begin::Section-->
                                                ...
                                                <div class="col-lg-6 mb-10 mb-lg-0">
                                                    ...
                                                    <div class="nav flex-column">
                                                        ...
                                                        <label
                                                            ...
                                                            <div class="ms-5">
                                                                <a href="#"
                                                                    class="btn btn-sm btn-success">Contact Us</a>
                                                            </div>
                                                            <!--end::Price-->
                                                        </label>
                                                        <!--end::Tab link-->
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="tab-content rounded h-100 bg-light p-10">
                                                        ...
                                                        <div class="tab-pane fade show active"
                                                            ...
                                                            <!--begin::Heading-->
                                                            <div class="pb-5">
                                                                <h2 class="fw-bold text-gray-900">What’s in Startup
                                                                    Plan?</h2>
                                                                ...
                                                                <label class="d-flex flex-stack cursor-pointer">
                                                                    ...
                                                                    <span class="d-flex align-items-center me-2">
                                                                        ...
                                                                        <span class="d-flex flex-column">
                                                                            ...
                                                                            <span class="fs-7 text-muted">Microsoft
                                                                                Fast NoSQL
                                                                                Database</span>
                                                                        </span>
                                                                        <!--end::Info-->
                                                                ...
                                                                <div class="col-md-4 fv-row">
                                                                    ...
                                                                    <div class="position-relative">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <i
                                                                                class="ki-duotone ki-credit-cart fs-2hx">
                                                                                <span class="path1"></span>
                                                                                <span class="path2"></span>
                                                                            </i>
                                                                        </div>
                                                        ...
                                                        <div>
                                                            <button type="button" class="btn btn-lg btn-primary"
                                                                ...
                                                                <span class="indicator-label">Submit
                                                                    <i
                                                                        class="ki-duotone ki-arrow-right fs-3 ms-2 me-0">
                                                                        <span class="path1"></span>
                                                                        <span class="path2"></span>
                                                                    </i></span>
                                                                <span class="indicator-progress">Please wait...
                                                            ...
                                                            <form id="kt_modal_add_user_form" class="form"
                                                                ...
                                                                <div class="d-flex flex-column scroll-y px-5 px-lg-10"
                                                                    ...
                                                                    <div class="fv-row mb-7">
                                                                        <label
                                                                            class="required fw-semibold fs-6 mb-2">Username</label>
                                                                    ...
                                                                    <div class="fv-row mb-7">
                                                                        <label
                                                                            class="required fw-semibold fs-6 mb-2">Konfirmasi
                                                                            Password</label>
                                                                        <input type="password"
                                                                    ...
                                                                    <!-- Role (Hidden karena hanya untuk admin) -->
                                                                    {{-- // Ambil langsung dari model jika variabel tidak tersedia --}}
                                                                    <input type="hidden" name="level_id"
                                                                        value="{{ App\Models\Level::where('name', 'admin')->first()->id }}">
                                                                    <!-- Actions -->
                                                                    <div class="text-center pt-10">
                                                                        ...
                                                                        <button type="submit"
                                                                            ...
                                                                            data-kt-users-modal-action="submit">
                                                                            <span
                                                                                class="indicator-label">Simpan</span>
